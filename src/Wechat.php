 ...
 * @property \EasyWeChat\OfficialAccount\Application $official 公众号
 * @property \EasyWeChat\MiniProgram\Application $miniProgram 小程序
 * @property \EasyWeChat\OpenPlatform\Application $open 开放平台
 * @property \EasyWeChat\Work\Application $weWork 开放平台
...
class Wechat extends Component
{
    ...
    {
        if (in_array($name, ['official', 'miniProgram', 'open', 'weWork', 'payment'])) {
            $this->app_type = $name;
            $this->setApp();
            return $this->app;
        }
